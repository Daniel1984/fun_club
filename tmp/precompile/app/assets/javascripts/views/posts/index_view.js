...
define(['backbone', 'views/posts/search_post_manager', 'views/posts/create_post_manager', 'views/posts/list_view', 'models/post', 'collections/posts', 'spin'], function(Backbone, SearchPostManager, CreatePostManager, ListView, Post, Posts, Spinner) {
  ...
  return PostsIndexView = (function(_super) {
    ...
    function PostsIndexView() {
      ...
      _ref = PostsIndexView.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    PostsIndexView.prototype.initialize = function(options) {
      ...
      this.posts.on('reset', this.renderList);
      this.post = new Post();
      return this.post.on('fetch', this.fetch);
    };
