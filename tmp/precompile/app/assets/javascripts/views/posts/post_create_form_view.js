...
define(['backbone', 'views/helpers/error_handler_view', 'text!templates/posts/post_create_form.html', 'text!templates/posts/search.html', 'backbone_datalink'], function(Backbone, ErrorHandler, template, CitySelectPartial) {
  ...
  return ProtocolCreateFormView = (function(_super) {
    ...
    ProtocolCreateFormView.prototype.initialize = function(options) {
      ...
      if (window.FileReader) {
        ...
        return this.$('.file-upload-container').hide();
      }
    };
    ...
    ProtocolCreateFormView.prototype.handleError = function(model, error) {
